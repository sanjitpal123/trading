    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.mainFooter}>
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerCol}>
            ...
            <div className={styles.socialGrid}>
              <a href="https://www.instagram.com/tradepulse142026/?hl=en" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
              </a>
              <a href="https://www.youtube.com/@TRADEPULSE-n7p" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="YouTube">
          ...
          <div className={styles.footerCol}>
            ...
            <a href="tel:+918927578901" className={styles.footerLink} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
              +91 8927578901
            </a>
            <a href="tel:+919422799531" className={styles.footerLink} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg>
              +91 9422799531
            </a>
            <div className={styles.footerLink} style={{ display: 'flex', alignItems: 'flex-start', gap: '8px', pointerEvents: 'none' }}>
              ...
              EN-66, Sector V, Bidhannagar<br/>Kolkata, West Bengal
            </div>
          </div>
        ...
        <div className={styles.disclaimer} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
          <p style={{ margin: 0, color: 'var(--text-secondary)' }}>&copy; {new Date().getFullYear()} Trade Pulse. All rights reserved.</p>
          <p style={{ margin: 0, fontWeight: 'bold' }}>
            <span style={{ color: '#fff' }}>Design and developed by </span>
            <span className={styles.devGradient}>goadslive</span>
          </p>
        </div>
      </div>
    </footer>
